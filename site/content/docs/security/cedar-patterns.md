...
description = "A copy-ready Cedar pattern library for hirn — least-privilege writers, read-only auditors, tenant isolation, guarded recall_raw_text, and a ship checklist."
weight = 2
+++

# Cedar Policy Patterns

This is the operator-facing pattern library for hirn's major Cedar action types. Use it alongside the broader [docs/cedar-guide.md](@/docs/security/cedar-guide.md).
