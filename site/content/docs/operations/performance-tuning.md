...
description = "Tune the knobs that move hirn in production — RPE routing, quality-gate escalation, consolidation pressure, graph activation, and provider runtime protections."
weight = 4
+++
...
See [Benchmarks](@/docs/benchmarks.md) for the benchmark surface currently shipped in the repository.
