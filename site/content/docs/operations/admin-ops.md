...
description = "Day-two operations for a hirn database — version-tagged snapshots, compaction, index creation, MCFA pattern management, and graceful shutdown."
weight = 2
+++
...
See also: [Architecture](@/docs/concepts/architecture.md), [Performance Tuning](@/docs/operations/performance-tuning.md), [Deployment](@/docs/operations/deployment.md)
